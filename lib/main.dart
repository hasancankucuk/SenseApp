...
void main() {
  runApp(new MaterialApp(
    title: 'Bitirme Ödevi',
    theme: ThemeData( primarySwatch: Colors.blue, fontFamily: 'PatrickHand',),
    home: Giris(),
  ));
}
  ...
  void initState() {
    ...
    Future.delayed(const Duration(seconds:3), () async {
      Navigator.pushReplacement(
          context, new MaterialPageRoute(builder: (context) => new Baslangic()));
    });
  }
    ...
    return Scaffold(
      ...
      //   Image.asset('assets/images/splash.png', width: 100, height: 100,),
          SizedBox(
              ...
              Text(
                "SENSEAPP", style: TextStyle(fontSize: 30),
              ),
        ],
        ),
      ),
